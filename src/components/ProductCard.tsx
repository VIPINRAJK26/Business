...
const ProductCard = ({
  ...
  return (
    <Card 
      className="group overflow-hidden border-0 shadow-soft hover-lift transition-all duration-500 bg-gradient-card"
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="aspect-square bg-muted/30 relative overflow-hidden">
          <div className="w-full h-full bg-gradient-to-br from-muted/20 to-muted/40 flex items-center justify-center">
            <span className="text-6xl opacity-60">{image}</span>
          </div>
        ...
        <CardContent className="p-4">
          ...
          {/* Product Name */}
          <h3 className="font-playfair font-semibold text-lg mb-2 line-clamp-2 group-hover:text-primary transition-colors duration-300">
            {name}
          </h3>
